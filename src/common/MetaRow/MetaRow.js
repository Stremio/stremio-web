...
const MetaRow = ({
  ...
  return (
    <div className={classnames(className, styles["meta-row-container"])}>
      ...
      (deepLinks &&
        (typeof deepLinks.discover === "string" ||
          typeof deepLinks.library === "string")) ? (
        <div className={styles["header-container"]}>
          ...
          (typeof deepLinks.discover === "string" ||
            ...
            <Button
              ...
              title={"SEE ALL"}
              href={deepLinks.discover || deepLinks.library}
              tabIndex={-1}
            >
      ...
      {typeof message === "string" && message.length > 0 ? (
        ...
        <div className={styles["meta-items-container"]}>
          {ReactIs.isValidElementType(itemComponent)
            ...
            : null}
          {Array(Math.max(0, CONSTANTS.CATALOG_PREVIEW_SIZE - items.length))
            .fill(null)
            .map((_, index) => (
              <div
                key={index}
