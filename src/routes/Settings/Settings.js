...
const Settings = () => {
  ...
  const { cacheSizeSelect, torrentProfileSelect } =
  ...
  const [selectedSectionId, setSelectedSectionId] =
    React.useState(GENERAL_SECTION);
  ...
  const sectionsContainerOnScorll = React.useCallback(
    throttle(() => {
    ...
    <MainNavBars className={styles["settings-container"]} route={"settings"}>
      ...
      >
        ...
        <div
          ...
          onScroll={sectionsContainerOnScorll}
        >
          <div ref={generalSectionRef} className={styles["section-container"]}>
            ...
            >
              ...
              <Button
                className={styles["user-panel-container"]}
                title={"User panel"}
                target={"_blank"}
            ...
            <div className={styles["option-container"]}>
              ...
              <Button
                ...
                disabled={true}
                tabIndex={-1}
                onClick={authenticateTraktOnClick}
              >
