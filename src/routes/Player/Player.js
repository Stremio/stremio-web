...
const Player = () => {
    ...
    React.useEffect(() => {
        ...
        if (isEpg) {
            if (currentEpgVideo === null || upcomingVideo === null) {
                closeNextVideoPopup();
                return;
            }
    ...
    }, [ isEpg, currentEpgVideo, upcomingVideo, epgNow, player.nextVideo, video.state.time, video.state.duration, settings.nextVideoNotificationDuration ]);
