...
const ControlBar = ({
  ...
  const [chromecastServiceActive, setChromecastServiceActive] = React.useState(
    () => chromecast.active
  );
      ...
      <div className={styles["control-bar-buttons-container"]}>
        ...
        >
          <Icon
            ...
            icon={
              typeof paused !== "boolean" || paused ? "ic_play" : "ic_pause"
            }
          />
        </Button>
        {nextVideo !== null ? (
        ...
        >
          <Button
            className={classnames(styles["control-bar-button"], "disabled")}
            tabIndex={-1}
          >
