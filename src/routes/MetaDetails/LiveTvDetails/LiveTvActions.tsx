...
const LiveTvActions = ({ streams, inLibrary, onToggleLibrary, onShowDetails }: Props) => {
    ...
    return (
        <div className={styles['playback']}>
            ...
            {streamsOpen && <ModalDialog className={styles['streams-modal']} title={optionsLabel} onCloseRequest={() => setStreamsOpen(false)} role={'dialog'} aria-modal={'true'} aria-label={optionsLabel}>
