...
storiesOf('Addon', module)
    .add('addon', () => (
        <div style={{ padding: '10px', overflow: 'auto' }} className={appStyles['app']}>
            <Addon
            ...
            <Addon
                ...
                types={['Movies', 'Series']}
                description={'Watch your favourite YouTube channels ad-free and get notified when they upload new videos.'}
                urls={['https://channels.strem.io/stremioget/stremio/v1', 'https://channels.strem.io/stremioget/stremio/v1', 'http://127.0.0.1:11470/addons/com.stremio.subtitles/stremioget', 'https://channels.strem.io/stremioget/stremio/v1']}
            />
        </div>
    ));
    ...
    .add('library item list', () => (
        <div style={{ padding: '10px', overflow: 'auto' }} className={appStyles['app']}>
            ...
            <LibraryItemList
                ...
                watchTrailer={function() { alert('4') }}
                addToLibrary={function() { alert('24') }}
                poster={'https://m.media-amazon.com/images/M/MV5BMTU5NDI1MjkwMF5BMl5BanBnXkFtZTgwNjIxNTY2MzI@._V1_UX182_CR0,0,182,268_AL_.jpg'}
            ...
            />
            <LibraryItemList
                poster={'https://m.media-amazon.com/images/M/MV5BODAxNDFhNGItMzdiMC00NDM1LWExYWUtZjNiMGIzYTc0MTM5XkEyXkFqcGdeQXVyMjYzMjA3NzI@._V1_UY268_CR3,0,182,268_AL_.jpg'}
                title={'Deadpool'}
                type={'Channel'}
                releaseInfo={new Date(2018)}
                released={new Date(2018, 4, 23)}
            ...
            />
            <LibraryItemList
                poster={'https://m.media-amazon.com/images/M/MV5BNGNiNWQ5M2MtNGI0OC00MDA2LWI5NzEtMmZiYjVjMDEyOWYzXkEyXkFqcGdeQXVyMjM4NTM5NDY@._V1_.jpg'}
